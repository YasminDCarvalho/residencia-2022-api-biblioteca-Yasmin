...
public class EditoraController {
	...
	@GetMapping("/save-cnpj/{cnpj}")
	public ResponseEntity<Editora> saveCnpjApiExterna(@PathVariable String cnpj) {
		return new ResponseEntity<> (editoraService.saveCnpjApiExterna(cnpj),
				HttpStatus.CREATED);
	}
